 ...
 */
 ...
 public class AlgorithmId implements Serializable, DerEncoder {
     ...
     public static AlgorithmId get(String algname)
         ...
         try {
             System.out.println("AlgorithmId --> get(String algname) --> algname is: " + algname);
             oid = algOID(algname);
             System.out.println("AlgorithmId --> get(String algname) --> get oid");
         } catch (IOException ioe) {
         ...
         System.out.println("AlgorithmId --> get(String algname) --> return AlgorithmId");
     ...
     private static ObjectIdentifier algOID(String name) throws IOException {
         ...
         System.out.print("Algorithm --> algOID() --> Did not find --> " + name);
     ...
     private static Map<String,ObjectIdentifier> oidTable()
         ...
         if ((tab = oidTable) == null) {
             System.out.println("AlgorithmId --> oidTable() --> (tab = oidTable) == null");
             synchronized (AlgorithmId.class) {
                 if ((tab = oidTable) == null)
                     System.out.println("AlgorithmId --> oidTable() --> synchronized (tab = oidTable) == null");
                     oidTable = tab = computeOidTable();
                     System.out.println("AlgorithmId --> oidTable() --> synchronized (tab = oidTable) == null, get oidTable");
             }
         }
         return tab;
     }
     ...
     private static HashMap<String,ObjectIdentifier> computeOidTable()
         ...
         for (Provider provider : Security.getProviders()) {
             System.out.println("AlgorithmId --> computeOidTable() --> provider is: " + provider.getName());
             for (Object key : provider.keySet()) {
                 String alias = (String)key;
                 System.out.println("AlgorithmId --> computeOidTable() --> provider is: " + provider.getName() + ", alias is: " + alias);
                 String upperCaseAlias = alias.toUpperCase(Locale.ENGLISH);
                 System.out.println("AlgorithmId --> computeOidTable() --> provider is: " + provider.getName() + ", upperCaseAlias is: " + alias);
                 int index;
                 if (upperCaseAlias.startsWith("ALG.ALIAS") &&
                     ...
                     System.out.println("AlgorithmId --> computeOidTable() --> provider is: " + provider.getName() + ", oidString is: " + oidString);
                     String stdAlgName = provider.getProperty(alias);
                     if (stdAlgName != null) {
                         stdAlgName = stdAlgName.toUpperCase(Locale.ENGLISH);
                         System.out.println("AlgorithmId --> computeOidTable() --> provider is: " + provider.getName() + ", stdAlgName is: " + stdAlgName);
                     }
                     if (stdAlgName != null &&
                         tab.get(stdAlgName) == null) {
                         System.out.println("AlgorithmId --> computeOidTable() --> provider is: " + provider.getName() + ", stdAlgName != null && tab.get(stdAlgName) == null");
