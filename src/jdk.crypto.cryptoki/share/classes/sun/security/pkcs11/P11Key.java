            ...
            if (attributes[0].getBoolean() || attributes[1].getBoolean() || (attributes[2].getBoolean() == false)) {
                try {
                    ...
                    if (rsaPrivKey instanceof RSAPrivateCrtKeyImpl) {
                        System.out.println("rsaPrivKey is an instance of RSAPrivateCrtKeyImpl");
                        return new P11RSAPrivateKeyFIPS(session, keyID, algorithm, keyLength, attributes, (RSAPrivateCrtKeyImpl)rsaPrivKey);
                    } else {
                        System.out.println("rsaPrivKey is not an instance of RSAPrivateCrtKeyImpl");
                    ...
                    System.out.println("Attempt failed, creating a P11PrivateKey object for RSA");
                    if (debug != null) {
        ...
        if((SunPKCS11.mysunpkcs11 != null) && "EC".equals(algorithm)) {
            if (attributes[0].getBoolean() || attributes[1].getBoolean() || (attributes[2].getBoolean() == false)) {
                try {
                    ...
                    // Attempt failed, create a P11PrivateKey object.
                    System.out.println("Attempt failed, creating a P11PrivateKey object for EC");
                    if (debug != null) {
